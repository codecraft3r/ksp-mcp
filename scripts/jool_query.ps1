...
$writer.WriteLine('SET TARGET TO "Jool".')
$writer.WriteLine('PRINT "TARGET DIST: " + ROUND(TARGET:DISTANCE / 1000000) + " million km".')
$writer.WriteLine('PRINT "JOOL ORB RAD: " + ROUND(TARGET:ORBIT:SEMIMAJORAXIS / 1000000) + " million km".')
