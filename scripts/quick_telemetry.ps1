...
$writer.WriteLine('PRINT "STATUS: " + SHIP:STATUS + " | ALT: " + ROUND(SHIP:ALTITUDE) + "m | VSPD: " + ROUND(SHIP:VERTICALSPEED) + "m/s | APO: " + ROUND(SHIP:APOAPSIS) + "m | STG: " + STAGE:NUMBER + " | THRUST: " + ROUND(AVAILABLETHRUST) + "kN".')
